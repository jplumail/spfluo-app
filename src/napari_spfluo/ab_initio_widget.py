...
from magicgui.widgets import CheckBox, Container, create_widget, PushButton, ComboBox
...
class AbInitioWidget(Container):
    ...
    def _run_ab_initio(self):
        ...
        ab_initio = AbInitioReconstruction(N_iter_max=1)
        @thread_worker
        ...
        worker = fitting()
        worker.returned.connect(self._viewer.add_image)
        worker.start()
