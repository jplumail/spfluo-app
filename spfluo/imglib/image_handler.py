...
import spfluo.objects as fluoobj
import spfluo.constants as fluocts
from spfluo.objects.data import Image
...
class ImageHandler(object):
    ...
    @classmethod
    def _convertToLocation(cls, location: Union[Tuple[int, str], str, Image]) -> Tuple[int, str]:
        ...
        if isinstance(location, tuple):
            ...
            outLocation = (fluocts.NO_INDEX, location)

        elif hasattr(location, 'getLocation'):
            # This case includes Image and its subclasses
            outLocation = (location.getIndex(), location.getFileName())
        else:
    ...
    def convert(self, inputObj: Union[], outputObj, dataType=None, transform=None):
