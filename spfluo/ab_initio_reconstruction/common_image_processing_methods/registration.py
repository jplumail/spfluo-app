...
def registration_exhaustive_search(fixed_image, moving_image, output_dir, output_name, sample_per_axis=40, gradient_descent=False, threads=1):
    ...
    if not gradient_descent:
        if nb_dim == 2:
            ...
            R.SetOptimizerAsExhaustive([sample_per_axis, sample_per_axis,
                                                      sample_per_axis, 0, 0, 0])
            R.SetOptimizerScales(
...
#
    ...
    for i in range(len(gts)):
        ...
        registration_exhaustive_search(pth_gt, pth_im, pth, f'{im_to_register[i]}_registered', 3,
