...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--depth_factor',             type=float,  default=1.)
    ...
    parser.add_argument('--crop_dir',                 type=str, default=None) # cropped particules to take for pretraining
...
def guess_paths(args: argparse.Namespace) -> argparse.Namespace:
    ...
    if args.predictions is None and ('postprocess' in args.stages or 'evaluate' in args.stages):
