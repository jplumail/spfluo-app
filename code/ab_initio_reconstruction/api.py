...
class AbInitioReconstruction:
    ...
    def fit(self, X, psf=None, output_dir=None, gpu=None):
        ...
        imp_distrs_axes = np.ones((N, params_learning_alg.M_axes)) / params_learning_alg.M_axes
        imp_distrs_rot = np.ones((N, params_learning_alg.M_rot)) / params_learning_alg.M_rot
