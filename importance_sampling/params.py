...
class ParametersMainAlg:
    def __init__(self, M_axes=360**2, M_rot=360, dec_prop=1.2, init_unif_prop=(1,1), coeff_kernel_axes=50., coeff_kernel_rot=5., eps=0, lr=0.1,
                 N_axes=25, N_rot=20, prop_min=0, interp_order=3, N_iter_max=20, gaussian_kernel=True, N_iter_with_unif_distr=None,
                 epochs_of_suppression=None, proportion_of_views_suppressed=None, convention='zxz', dtype=np.float32, reg_coeff=0, beta_sampling=0,
                 epoch_length=None, batch_size=1, beta_grad=0, random_sampling=False):
        self.params = locals()
        self.M_axes = M_axes
        self.M_rot = M_rot
...
class ParametersDataGeneration:
    def __init__(self, nb_dim=3, nb_views=10, sig_z=5,sig_xy=1,snr=100,order=3,
                              sigma_trans_ker=0, size=50, psf=None, projection=False, rot_vecs=None, convention='zxz', partial_labelling=False, **partial_labelling_args):
        self.params = locals()
